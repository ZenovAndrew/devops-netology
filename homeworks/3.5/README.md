...
```
Данный функционал знал ранее, когда создавал образы скрытых разделов

#### 2. Могут ли файлы, являющиеся жесткой ссылкой на один объект, иметь разные права доступа и владельца? Почему?

Не могут, т.к. жесткая ссылка- это ссылка на один и тот же самый файл с тем же inode, то права будут одни и те же.
...
--2021-11-22 12:30:12--  https://mirror.yandex.ru/ubuntu/ls-lR.gz
...
2021-11-22 12:36:23 (4.27 MB/s) - ‘/tmp/new/test.gz’ saved [22478325/22478325]
```
...
[ 10365.476216] md/raid1:md0: Disk failure on sdb1, disabling device.
